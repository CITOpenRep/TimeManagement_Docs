...
### Verbeterde Rich Text Voorbeeldweergave & HTML-opschoning
* **Schone Opmaakweergave**: De voorbeeldengine verwijdert ongewenste HTML-opmaakartefacten, achtergebleven tags en ruwe markup, zodat rijke beschrijvingen zuiver en nauwkeurig worden weergegeven.
* **Schakelen tussen Voorbeeld en Bewerken**:
    * **Werkbalk Samenvouwen `[-]`**: Tik op het inklapicoon in de bovenste koptekst om over te schakelen naar een schone leesweergave, waarbij de opmaakwerkbalk wordt verborgen voor een afleidingsvrije beoordeling.
    * **Werkbalk Uitvouwen `[+]`**: Tik op het uitklapicoon in de bovenste koptekst om de opmaakwerkbalk te herstellen en het bewerken te hervatten.
