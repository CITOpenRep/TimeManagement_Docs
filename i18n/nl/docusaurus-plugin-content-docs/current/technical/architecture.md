...
- `docs/`: brondocumentatie (verplaatst naar de speciale TimeManagement_Docs repository)
...
- hoe bijdragers moeten redeneren over veranderingen die QML, JS en Python omvatten
