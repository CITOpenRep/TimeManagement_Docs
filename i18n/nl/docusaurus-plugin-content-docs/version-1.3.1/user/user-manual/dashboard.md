...
* **Filter-icoon (Schuifregelaars):** Opent het vervolgkeuzemenu van het datumbereikfilter om de tijdsperiode van de weergegeven gegevens aan te passen.
...
## Datumbereikfilter
Een nieuwe filterfunctie stelt gebruikers in staat om de tijdsperiode te bepalen voor de gegevens die op het hele dashboard worden weergegeven.

* **Standaardweergave:** Standaard toont het dashboard gegevens voor **Deze maand**.
* **Filteropties:** Door op het filter-icoon in de koptekst te klikken, wordt een vervolgkeuzemenu "Datumbereik" geopend met de volgende vooraf gedefinieerde opties:
    * Geen filter (Altijd)
    * Vandaag
    * Deze week
    * Deze maand
    ...
    * Dit jaar
    * Aangepast bereik...
* **Aangepast datumbereik:** Als u "Aangepast bereik..." selecteert, wordt er een apart dialoogvenster geopend. Gebruikers kunnen een exacte tijdsperiode opgeven door een **Van:**-datum en een **Tot:**-datum te selecteren met behulp van de datumkiezers. Klikken op **Bereik toepassen** werkt het dashboard bij om deze aangepaste periode weer te geven, terwijl klikken op **Annuleren** het dialoogvenster sluit zonder wijzigingen aan te brengen.
...
### Tijdweergave:
Elke categorie toont de totale bestede tijd (bijv. `98H`), wat gebruikers helpt bij het evalueren van productiviteit en tijdsbesteding voor het geselecteerde datumbereik.
...
* **Bestede Tijd per Project (Staafdiagram):** Toont de bestede tijd per project. De assen maken een visuele vergelijking van de inspanning over projecten mogelijk. Bevat de knoppen **"Toon volgende 10"** en **"Toon minder"** die onderaan beschikbaar zijn om de projectenlijst uit te breiden.
