...
function DashboardChartsIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function ConvergenceIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M10 19v-4" />
      <path d="M6 19h8" />
      <rect width="6" height="10" x="16" y="12" rx="1" />
    </svg>
  );
}
...
function TimerSmallIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function TasksCheckIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function DeviceSimulator() {
  ...
  const menuItems = [
    { name: "Dashboard", icon: HomeIcon, target: "Dashboard" },
    { name: "Timesheet", icon: TimerSmallIcon, target: "Timesheets" },
    { name: "Activities", icon: CalendarIcon, target: "Activities" },
    { name: "My Tasks", icon: StarIcon, target: "My Tasks" },
    { name: "All Tasks", icon: TasksCheckIcon, target: "All Tasks" },
    { name: "Projects", icon: FolderIcon, target: "Projects" },
    { name: "Project Updates", icon: HistoryIcon, target: "Project Updates" },
    { name: "About Us", icon: InfoIcon, target: "About Us" },
    { name: "Settings", icon: SettingsIcon, target: "Settings" }
  ];
        ...
        return (
          ...
          >
            <span className={styles.menuItemIcon}>
              {typeof Icon === "function" ? <Icon className={styles.menuItemIconSvg} /> : Icon}
            </span>
            <span>{item.name}</span>
          </li>
        );
      ...
      <div className={styles.matrixWrapper}>
        ...
        <div className={styles.matrixBodyRow}>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardUrgentImportant)}>
            <div className={styles.matrixCardIcon}>
              <TasksCheckIcon className={styles.matrixCardIconSvg} />
            </div>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardNoturgentImportant)}>
            <div className={styles.matrixCardIcon}>
              <HistoryIcon className={styles.matrixCardIconSvg} />
            </div>
        ...
        <div className={styles.matrixBodyRow}>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardUrgentNotimportant)}>
            <div className={styles.matrixCardIcon}>
              <TimerSmallIcon className={styles.matrixCardIconSvg} />
            </div>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardNoturgentNotimportant)}>
            <div className={styles.matrixCardIcon}>
              <TrashIcon className={styles.matrixCardIconSvg} />
            </div>
            ...
            <div className={styles.controlGroup}>
              <div>
                ...
                <div className={styles.toggleRow}>
                  ...
                  >
                    <LaptopIcon className={styles.btnIcon} />
                    <span>Convergent (Tablet/Desktop)</span>
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className={styles.toggleRow}>
                  ...
                  >
                    <TimerSmallIcon className={styles.btnIcon} />
                ...
                <div className={styles.toggleRow}>
                  ...
                  >
                    <FileEditIcon className={styles.btnIcon} />
                  ...
                  >
                    <TasksCheckIcon className={styles.btnIcon} />
                    <span>Tasks</span>
                  </button>
                </div>
                <div className={styles.toggleRow}>
                  ...
                  >
                    <HistoryIcon className={styles.btnIcon} />
                    <span>Updates</span>
                  </button>
                </div>
                <div className={styles.toggleRow}>
                  ...
                  >
                    <SettingsIcon className={styles.btnIcon} />
                    <span>Settings</span>
                  </button>
                  <button 
                  ...
                  >
                    <InfoIcon className={styles.btnIcon} />
                    <span>About Us</span>
                  </button>
                </div>
              </div>
              ...
              <div style={{ marginTop: "16px", paddingTop: "16px", borderTop: "1px dashed rgba(255, 255, 255, 0.15)" }}>
                ...
                <button 
                  ...
                  style={{ marginTop: "12px", width: "100%", display: "inline-flex", justifyContent: "center", alignItems: "center", gap: "6px", fontSize: "0.75rem", padding: "6px" }}
                >
                  <RotateCcwIcon className={styles.btnIcon} />
                  <span>Reset Dimensions</span>
                </button>
              </div>

              <div className={styles.gestureHint}>
                <LightbulbIcon className={styles.gestureHintIcon} />
