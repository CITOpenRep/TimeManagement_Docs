...
The application is divided into several interconnected modules to provide a seamless workflow:

- **Dashboard**: Acts as the main screen, providing a quick overview of tasks, projects, and time distribution based on priority.
